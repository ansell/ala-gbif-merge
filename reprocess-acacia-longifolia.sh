...
../../csvsum/csvsum --input "${ACACIA_ALA_OUTPUT_FOLDER}Source-AcaciaLongifolia-ALA.csv" --output "Statistics-AcaciaLongifolia-ALA.csv" --show-sample-counts true --samples 1000

../../dwca-utils/csv2dwca --input "${ACACIA_ALA_OUTPUT_FOLDER}Source-AcaciaLongifolia-ALA.csv" --output "${ACACIA_ALA_OUTPUT_FOLDER}meta.xml" --core-id-index "${ACACIA_ALA_CORE_ID_INDEX}" --header-line-count 1 --show-defaults true
...
../../dwca-utils/dwcacheck --input "${OUTPUT_FOLDER}Mapped-AcaciaLongifolia-ALA-Archive.zip" --output "./dwcacheck-AcaciaLongifolia-ALA-analysis/"
...
../../csvsum/csvsum --input "${ACACIA_GBIF_OUTPUT_FOLDER}Source-AcaciaLongifolia-GBIF.csv" --output "Statistics-AcaciaLongifolia-GBIF.csv" --show-sample-counts true --samples 1000 --output-mapping "${ACACIA_GBIF_OUTPUT_FOLDER}Mapping-AcaciaLongifolia-GBIF.csv"

../../csvsum/csvmap --input "${ACACIA_GBIF_OUTPUT_FOLDER}Source-AcaciaLongifolia-GBIF.csv" --output "${ACACIA_GBIF_OUTPUT_FOLDER}Mapped-AcaciaLongifolia-GBIF.csv" --mapping "Mapping-AcaciaLongifolia-GBIF.csv"

../../csvsum/csvsum --input "${ACACIA_GBIF_OUTPUT_FOLDER}Mapped-AcaciaLongifolia-GBIF.csv" --output "Statistics-Mapped-AcaciaLongifolia-GBIF.csv" --show-sample-counts true --samples 1000

../../dwca-utils/csv2dwca --input "${ACACIA_GBIF_OUTPUT_FOLDER}Mapped-AcaciaLongifolia-GBIF.csv" --output "${ACACIA_GBIF_OUTPUT_FOLDER}meta.xml" --core-id-index "${ACACIA_GBIF_CORE_ID_INDEX}" --header-line-count 1 --show-defaults true --match-case-insensitive true
...
../../dwca-utils/dwcacheck --input "${OUTPUT_FOLDER}Mapped-AcaciaLongifolia-GBIF-Archive.zip" --output "./dwcacheck-AcaciaLongifolia-GBIF-analysis/"
...
../../dwca-utils/dwcamerge --input "${OUTPUT_FOLDER}Mapped-AcaciaLongifolia-ALA-Archive.zip" --other-input "${OUTPUT_FOLDER}Mapped-AcaciaLongifolia-GBIF-Archive.zip" --output "${ACACIA_MERGED_OUTPUT_FOLDER}"
...
../../dwca-utils/dwcacheck --input "${OUTPUT_FOLDER}Mapped-AcaciaLongifolia-Merged-Archive.zip" --output "./dwcacheck-AcaciaLongifolia-Merged-analysis/"
...
../../dwca-utils/dwcamerge --input "${OUTPUT_FOLDER}Mapped-AcaciaLongifolia-ALA-Archive.zip" --other-input "${OUTPUT_FOLDER}Mapped-AcaciaLongifolia-GBIF-Archive.zip" --output "${ACACIA_MERGED_CLEAN_OUTPUT_FOLDER}" --remove-non-vocabulary-terms true
...
../../dwca-utils/dwcacheck --input "${OUTPUT_FOLDER}Mapped-AcaciaLongifolia-Merged-Clean-Archive.zip" --output "./dwcacheck-AcaciaLongifolia-Merged-Clean-analysis/"
